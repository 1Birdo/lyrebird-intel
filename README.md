...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 2,869 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 527 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 219 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 3,590 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 1,394 per-address write-ups of reported attacks |
