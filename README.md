...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 8,002 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,640 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 527 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 7,633 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 3,126 per-address write-ups of reported attacks |
...
*Generated 2026-09-24 06:14 UTC.*
