...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 2,151 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 416 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 158 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 2,789 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 1,150 per-address write-ups of reported attacks |
