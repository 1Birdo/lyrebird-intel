...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 4,941 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,055 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 368 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,046 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,098 per-address write-ups of reported attacks |
...
*Generated 2026-09-17 06:12 UTC.*
