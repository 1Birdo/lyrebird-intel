...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 6,542 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,372 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 452 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 5,419 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,649 per-address write-ups of reported attacks |
