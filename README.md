...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 9,323 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,784 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 554 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 9,195 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 3,424 per-address write-ups of reported attacks |
