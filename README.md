...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 5,721 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,181 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 395 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,267 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,359 per-address write-ups of reported attacks |
