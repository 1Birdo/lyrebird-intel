...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 5,208 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,077 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 373 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,104 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,169 per-address write-ups of reported attacks |
