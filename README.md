...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 5,918 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,211 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 400 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,345 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,434 per-address write-ups of reported attacks |
