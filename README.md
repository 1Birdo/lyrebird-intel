...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 5,823 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,196 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 395 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,308 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,396 per-address write-ups of reported attacks |
