...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 7,204 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,517 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 484 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 6,558 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,871 per-address write-ups of reported attacks |
