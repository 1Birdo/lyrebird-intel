...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 7,857 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,627 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 512 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 7,451 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 3,092 per-address write-ups of reported attacks |
...
*Generated 2026-09-24 00:16 UTC.*
