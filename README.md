...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 2,771 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 516 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 210 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 3,475 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 1,357 per-address write-ups of reported attacks |
