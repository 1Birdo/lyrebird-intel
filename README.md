...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 6,436 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,346 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 424 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 5,090 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,610 per-address write-ups of reported attacks |
...
*Generated 2026-09-20 18:05 UTC.*
