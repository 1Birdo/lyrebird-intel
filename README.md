...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 4,374 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 909 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 305 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 3,924 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 1,910 per-address write-ups of reported attacks |
...
*Generated 2026-09-16 00:09 UTC.*
