...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 6,643 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,390 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 463 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 5,661 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,678 per-address write-ups of reported attacks |
