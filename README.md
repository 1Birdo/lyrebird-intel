...
| path | what |
|---|---|
| `iocs/source-ips.csv` | 5,089 attacking addresses with evidence summary |
| `iocs/payload-urls.csv` | 1,064 URLs attackers tried to fetch malware from |
| `iocs/sample-hashes.csv` | 370 delivered samples, hashed |
| `credentials/attempted-credentials.csv` | 4,084 distinct username/password pairs |
| `samples/` | the captured binaries, zip-encrypted |
| `incidents/` | 2,137 per-address write-ups of reported attacks |
